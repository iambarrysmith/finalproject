...
function validate(){
  ...
  createPage(pages[i]);
    ...
    document.body.querySelector(".login").style.display="none";
          ...
          messEle.innerHTML = "Incorrect password. Please try again."}
  
       else if(password === "password"){
          messEle.innerHTML = "Incorrect username. Please try again."
          }
        else{ messEle.innerHTML = "Incorrect username and password. Please try again."}
};
...
//    if(studentName.length>0 && number.length>0){
...
var studentName=document.body.querySelector(".student").value;
  ...
  document.body.querySelector(".subMess").innerHTML = "Invalid input. Please try again. Make sure something is entered for the student's name and grade, and that their grade is ONLY a number between 0 and 100."
    }
});
